...
interface ImportProductFlavourProps {
  drawerOpen: boolean;
...
const ImportProductFlavour: React.FC<ImportProductFlavourProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('product_flavours');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple product flavours. Download
...
export default ImportProductFlavour;
