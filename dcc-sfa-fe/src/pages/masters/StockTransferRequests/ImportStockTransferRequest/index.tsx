...
interface ImportStockTransferRequestProps {
  drawerOpen: boolean;
...
const ImportStockTransferRequest: React.FC<ImportStockTransferRequestProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('stock_transfer_requests');
    } catch (error) {
  ...
  return (
    <CustomDrawer
      ...
      title="Import Stock Transfer Requests"
      size="large"
    >
      <Box className="!p-5">
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple stock transfer requests.
...
export default ImportStockTransferRequest;
