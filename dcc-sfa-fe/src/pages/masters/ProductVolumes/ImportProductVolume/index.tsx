...
interface ImportProductVolumeProps {
  drawerOpen: boolean;
...
const ImportProductVolume: React.FC<ImportProductVolumeProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('product_volumes');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple product volumes. Download
...
export default ImportProductVolume;
