...
interface ImportCustomerCategoryProps {
  drawerOpen: boolean;
...
const ImportCustomerCategory: React.FC<ImportCustomerCategoryProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('customer_category');
    } catch (error) {
  ...
  return (
    <CustomDrawer
      ...
      title="Import Outlet Categories"
    >
      <Box className="!p-5">
...
export default ImportCustomerCategory;
