...
interface ImportAssetSubTypeProps {
  drawerOpen: boolean;
  setDrawerOpen: (drawerOpen: boolean) => void;
}

const ImportAssetSubType: React.FC<ImportAssetSubTypeProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('asset_sub_types');
    } catch (error) {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      console.error('Error importing asset sub types:', error);
    }
  };
  ...
  return (
    <CustomDrawer
      ...
      title="Import Asset Sub Types"
    >
      <Box className="!p-5">
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple asset sub types. Download
...
export default ImportAssetSubType;
