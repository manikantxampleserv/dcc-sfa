...
interface ImportKpiTargetProps {
  drawerOpen: boolean;
...
const ImportKpiTarget: React.FC<ImportKpiTargetProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('employee_kpi_targets');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple KPI targets. Download the
...
export default ImportKpiTarget;
