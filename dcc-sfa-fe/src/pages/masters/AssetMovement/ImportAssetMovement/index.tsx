...
interface ImportAssetMovementProps {
  drawerOpen: boolean;
...
const ImportAssetMovement: React.FC<ImportAssetMovementProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('asset_movements');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple asset movements. Download
...
export default ImportAssetMovement;
