...
interface ImportCoolerTypeProps {
  drawerOpen: boolean;
...
const ImportCoolerType: React.FC<ImportCoolerTypeProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('cooler_types');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple cooler types. Download the
...
export default ImportCoolerType;
