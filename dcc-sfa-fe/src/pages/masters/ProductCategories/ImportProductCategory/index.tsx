...
interface ImportProductCategoryProps {
  drawerOpen: boolean;
...
const ImportProductCategory: React.FC<ImportProductCategoryProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('product_categories');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple product categories.
...
export default ImportProductCategory;
