...
interface ImportSalesTargetProps {
  drawerOpen: boolean;
...
const ImportSalesTarget: React.FC<ImportSalesTargetProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('sales-targets');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple sales targets. Download
...
export default ImportSalesTarget;
