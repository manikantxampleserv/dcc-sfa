...
interface ImportUnitOfMeasurementProps {
  drawerOpen: boolean;
...
const ImportUnitOfMeasurement: React.FC<ImportUnitOfMeasurementProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('unit_of_measurement');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple units of measurement.
...
export default ImportUnitOfMeasurement;
