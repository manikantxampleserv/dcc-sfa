...
interface ImportTaxMasterProps {
  drawerOpen: boolean;
...
const ImportTaxMaster: React.FC<ImportTaxMasterProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('tax_master');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple tax masters. Download the
...
export default ImportTaxMaster;
