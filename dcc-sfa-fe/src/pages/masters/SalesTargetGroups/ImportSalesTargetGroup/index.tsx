...
interface ImportSalesTargetGroupProps {
  drawerOpen: boolean;
...
const ImportSalesTargetGroup: React.FC<ImportSalesTargetGroupProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('sales_target_groups');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple sales target groups.
...
export default ImportSalesTargetGroup;
