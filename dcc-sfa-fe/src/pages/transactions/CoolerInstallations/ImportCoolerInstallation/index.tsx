...
interface ImportCoolerInstallationProps {
  drawerOpen: boolean;
...
const ImportCoolerInstallation: React.FC<ImportCoolerInstallationProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('cooler_installations');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple cooler installations.
...
export default ImportCoolerInstallation;
