...
interface ImportReturnRequestProps {
  drawerOpen: boolean;
...
const ImportReturnRequest: React.FC<ImportReturnRequestProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('return_requests');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple return requests. Download
...
export default ImportReturnRequest;
