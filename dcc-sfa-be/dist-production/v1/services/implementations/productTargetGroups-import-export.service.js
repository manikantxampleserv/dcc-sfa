...
exports.ProductTargetGroupsImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
class ProductTargetGroupsImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'product_target_group';
    displayName = 'Product Target Groups';
    ...
    columns = [
        {
            ...
            description: 'Name of the product target group (required, 2-255 characters)',
        },
        {
            key: 'code',
            header: 'Code',
    ...
    async checkDuplicate(data, tx) {
        const model = tx ? tx.product_target_group : prisma_client_1.default.product_target_group;
...
exports.ProductTargetGroupsImportExportService = ProductTargetGroupsImportExportService;
//# sourceMappingURL=productTargetGroups-import-export.service.js.map