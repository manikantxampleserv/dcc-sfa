 ...
 */
export declare const buildPermissionName: (
  module: Modules,
  action: Actions
) => string;
/**
 ...
 */
export declare const hasAnyModulePermissions: (
 ...
 */
export declare const hasAllModulePermissions: (
  userPermissions: string[],
  permissions: Array<{
    module: Modules;
    action: Actions;
 ...
 */
export declare const formatPermissionErrorMessage: (
  permissions: Array<{
    module: Modules;
    action: Actions;
  }>
