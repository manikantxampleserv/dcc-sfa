...
const salespersonStock_controller_1 = require("../controllers/salespersonStock.controller");
const auth_middleware_1 = require("../../middlewares/auth.middleware");
const router = express_1.default.Router();
router.get('/inventory-item-salesperson', auth_middleware_1.authenticateToken, salespersonStock_controller_1.salespersonStockController.getSalespersonInventory);
router.get('/inventory-item-salesperson-summary/:salesperson_id', auth_middleware_1.authenticateToken, salespersonStock_controller_1.salespersonStockController.getSalespersonSummary);
...
router.get('/inventory-item-salesperson/:salesperson_id', auth_middleware_1.authenticateToken, salespersonStock_controller_1.salespersonStockController.getSalespersonInventory);
