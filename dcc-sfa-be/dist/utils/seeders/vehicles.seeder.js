...
exports.mockVehicles = void 0;
exports.seedVehicles = seedVehicles;
exports.clearVehicles = clearVehicles;
...
exports.mockVehicles = mockVehicles;
/**
...
async function seedVehicles() {
    try {
        for (const vehicle of mockVehicles) {
            const existingVehicle = await prisma_client_1.default.vehicles.findFirst({
                where: { vehicle_number: vehicle.vehicle_number },
            });
            if (!existingVehicle) {
                await prisma_client_1.default.vehicles.create({
                    data: {
...
async function clearVehicles() {
    try {
        await prisma_client_1.default.vehicles.deleteMany({});
    }
    catch (error) {
        throw error;
    }
