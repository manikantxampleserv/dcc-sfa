...
exports.mockDepots = void 0;
exports.seedDepots = seedDepots;
exports.clearDepots = clearDepots;
...
async function seedDepots() {
    try {
        ...
        if (companies.length === 0) {
            logger_1.default.warn('No active companies found. Skipping depots seeding.');
            return;
        }
        ...
        for (const depot of mockDepots) {
            const existingDepot = await prisma_client_1.default.depots.findFirst({
                where: { name: depot.name },
            });
            if (!existingDepot) {
                await prisma_client_1.default.depots.create({
                    data: {
        ...
        logger_1.default.info(`Depots seeding completed: ${depotsCreated} created, ${depotsSkipped} skipped`);
    }
    catch (error) {
        logger_1.default.error('Error seeding depots:', error);
        throw error;
    }
}
/**
 * Clear Depots data
 */
async function clearDepots() {
    try {
        await prisma_client_1.default.depots.deleteMany({});
    }
    catch (error) {
        throw error;
    }
}
//# sourceMappingURL=depots.seeder.js.map