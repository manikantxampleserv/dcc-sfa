...
exports.seedKPITargets = seedKPITargets;
exports.clearKPITargets = clearKPITargets;
...
async function seedKPITargets() {
    try {
        ...
        if (users.length === 0) {
            logger_1.default.warn('No active users found. Skipping KPI targets seeding.');
            return;
        }
        ...
        for (const target of mockKPITargets) {
            ...
            if (!existingTarget) {
                await prisma_client_1.default.employee_kpi_targets.create({
                    data: {
                        employee_id: user.id,
                        kpi_name: target.kpi_name,
        ...
        logger_1.default.info(`KPI Targets seeding completed: ${targetsCreated} created, ${targetsSkipped} skipped`);
    }
    catch (error) {
        logger_1.default.error('Error seeding KPI targets:', error);
        throw error;
    }
}
/**
 ...
 */
async function clearKPITargets() {
    try {
        await prisma_client_1.default.employee_kpi_targets.deleteMany({});
    }
    catch (error) {
        throw error;
    }
}
//# sourceMappingURL=kpi-targets.seeder.js.map