...
router.put('/asset-master/:id', auth_middleware_1.authenticateToken, multer_1.upload.array('assetImages', 10), (0, audit_middleware_1.auditUpdate)('asset_master'), (0, auth_middleware_1.requirePermission)([{ module: 'asset-master', action: 'update' }]), assetMaster_validation_1.updateAssetMasterValidation, validation_middleware_1.validate, assetMaster_controller_1.assetMasterController.updateAssetMaster);
