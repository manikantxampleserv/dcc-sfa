...
router.post('/asset-movement', auth_middleware_1.authenticateToken, (0, audit_middleware_1.auditCreate)('asset_movements'), (0, auth_middleware_1.requirePermission)([{ module: 'asset-movement', action: 'create' }]), validation_middleware_1.validate, assetMovements_controller_1.assetMovementsController.createAssetMovements);
...
router.post('/asset-movement/:id/generate-contract', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requirePermission)([{ module: 'asset-movement', action: 'create' }]), assetMovements_controller_1.assetMovementsController.generateContract);
router.get('/asset-movement/:id/download-contract', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requirePermission)([{ module: 'asset-movement', action: 'read' }]), assetMovements_controller_1.assetMovementsController.downloadContract);
router.get('/asset-movement/:id/contract-info', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requirePermission)([{ module: 'asset-movement', action: 'read' }]), assetMovements_controller_1.assetMovementsController.getContractInfo);
