...
router.post('/customers/location-change-request', auth_middleware_1.authenticateToken, customer_controller_1.customerController.createLocationChangeRequest);
...
]), (0, audit_middleware_1.auditCreate)('customers'), customer_controller_1.customerController.bulkUpsertCustomers);
