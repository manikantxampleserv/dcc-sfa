...
exports.AuditLogsImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
class AuditLogsImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'audit_logs';
    displayName = 'Audit Logs';
    uniqueFields = ['id'];
    searchFields = ['table_name', 'action', 'changed_by', 'ip_address'];
    columns = [
        {
            key: 'id',
            header: 'Audit ID',
    ...
    async exportToExcel(options = {}) {
        ...
        Object.keys(userCount)
            ...
            .slice(0, 10)
            .forEach(userId => {
            const user = data.find((audit) => audit.changed_by === parseInt(userId));
            const userName = user?.users_audit_logs_changed_byTousers?.name || `User ${userId}`;
            summarySheet.addRow({
                metric: `  ${userName}`,
...
exports.AuditLogsImportExportService = AuditLogsImportExportService;
//# sourceMappingURL=auditLogs-import-export.service.js.map