...
exports.StockTransferRequestsImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
class StockTransferRequestsImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'stock_transfer_requests';
    displayName = 'Stock Transfer Requests';
    uniqueFields = ['request_number'];
    searchFields = [
        'request_number',
        'source_type',
        'destination_type',
    ...
    columns = [
        ...
        },
        {
            ...
            description: 'Request status (pending, approved, rejected, in_progress, completed)',
        },
        {
            key: 'approved_by',
            header: 'Approved By',
    ...
    async checkDuplicate(data, tx) {
        const model = tx
            ...
            : prisma_client_1.default.stock_transfer_requests;
    ...
    async exportToExcel(options = {}) {
        ...
        exportData.forEach((row, index) => {
            const excelRow = worksheet.addRow({
                ...row,
                requested_by_name: data[index]?.stock_transfer_requests_requested_by?.name || '',
                approved_by_name: data[index]?.stock_transfer_requests_approved_by?.name || '',
                source_name: data[index]?.stock_transfer_requests_source?.name || '',
                destination_name: data[index]?.stock_transfer_requests_destination?.name || '',
...
exports.StockTransferRequestsImportExportService = StockTransferRequestsImportExportService;
//# sourceMappingURL=stockTransferRequests-import-export.service.js.map