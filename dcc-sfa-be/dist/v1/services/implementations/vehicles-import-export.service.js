...
exports.VehiclesImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
class VehiclesImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'vehicles';
    displayName = 'Vehicles';
    uniqueFields = ['vehicle_number'];
    searchFields = ['vehicle_number', 'type', 'make', 'model'];
    columns = [
        {
            key: 'vehicle_number',
        ...
        },
        {
            ...
            validation: value => {
                ...
                if (value.length > 20)
                    return 'Type must be less than 20 characters';
                return true;
            },
            description: 'Type of vehicle (required, max 20 chars, e.g., Truck, Van, Car)',
        },
        {
            key: 'make',
            header: 'Make',
            width: 20,
            type: 'string',
            validation: value => !value || value.length <= 50 || 'Make must be less than 50 characters',
        ...
        },
        {
            ...
            width: 20,
            type: 'string',
            validation: value => !value || value.length <= 50 || 'Model must be less than 50 characters',
        ...
        },
        {
            ...
            validation: value => {
                ...
                return ((year >= 1900 && year <= 2100) || 'Year must be between 1900 and 2100');
            },
        ...
        },
        {
            ...
            width: 15,
            type: 'number',
            validation: value => !value || !isNaN(parseFloat(value)) || 'Capacity must be a number',
        ...
        },
        {
            ...
            description: 'Type of fuel (optional, max 20 chars, e.g., Diesel, Petrol, Electric)',
        },
        {
            key: 'status',
            header: 'Status',
            ...
            description: 'Vehicle status (optional, max 20 chars, e.g., available, in-use, maintenance)',
        },
        {
            key: 'mileage',
            header: 'Mileage',
            width: 15,
            type: 'number',
            validation: value => !value || !isNaN(parseFloat(value)) || 'Mileage must be a number',
    ...
    async checkDuplicate(data, tx) {
        const model = tx ? tx.vehicles : prisma_client_1.default.vehicles;
...
exports.VehiclesImportExportService = VehiclesImportExportService;
//# sourceMappingURL=vehicles-import-export.service.js.map