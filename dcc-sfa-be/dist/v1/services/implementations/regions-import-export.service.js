...
exports.RegionsImportExportService = void 0;
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
const import_export_service_1 = require("../base/import-export.service");
class RegionsImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'regions';
    displayName = 'Regions';
    uniqueFields = ['code'];
    ...
    columns = [
        {
            ...
            validation: value => {
                ...
                if (value.length > 255)
                    return 'Region name must be less than 255 characters';
                return true;
            },
        ...
        },
        {
            ...
            validation: value => {
                ...
                if (value.length > 50)
                    return 'Region code must be less than 50 characters';
                return true;
            },
...
exports.RegionsImportExportService = RegionsImportExportService;
//# sourceMappingURL=regions-import-export.service.js.map