...
export declare class RouteImportExportService extends ImportExportService<routes> {
    protected modelName: "routes";
...
//# sourceMappingURL=route-import-export.service.d.ts.map