...
exports.CoolerInstallationsImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
class CoolerInstallationsImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'coolers';
    displayName = 'Cooler Installations';
    uniqueFields = ['code'];
    searchFields = [
        'code',
        'brand',
    ...
    async updateExisting(data, userId, tx) {
        ...
        return await model.update({
            ...
            data: {
                ...
                energy_rating: data.energy_rating !== undefined
                    ? data.energy_rating
...
exports.CoolerInstallationsImportExportService = CoolerInstallationsImportExportService;
//# sourceMappingURL=coolerInstallations-import-export.service.js.map