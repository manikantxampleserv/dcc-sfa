...
exports.UserImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
const bcrypt_1 = __importDefault(require("bcrypt"));
class UserImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'users';
    displayName = 'Users';
    ...
    columns = [
        ...
        },
        {
            ...
            description: 'User password (optional, defaults to "Welcome@123", min 6 chars)',
        },
        {
            key: 'role_id',
            header: 'Role ID',
        ...
        },
        {
            ...
            description: 'Employee identification number (optional, must be unique if provided)',
        },
        {
            key: 'phone_number',
            header: 'Phone Number',
        ...
        },
        {
            ...
            transform: value => (value ? parseInt(value) : null),
            description: 'Manager/Supervisor User ID (optional, must exist in users table)',
        },
        {
            key: 'joining_date',
            header: 'Joining Date',
    ...
    async checkDuplicate(data, tx) {
        const model = tx ? tx.users : prisma_client_1.default.users;
        if (data.email) {
    ...
    async updateExisting(data, userId, tx) {
        ...
        if (data.password) {
            updateData.password_hash = await bcrypt_1.default.hash(data.password, 10);
        }
...
exports.UserImportExportService = UserImportExportService;
//# sourceMappingURL=UserImportExportService.js.map