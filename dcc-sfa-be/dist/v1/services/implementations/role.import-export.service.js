...
exports.RoleImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
class RoleImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'roles';
    displayName = 'Roles';
    uniqueFields = ['name', 'role_key'];
    searchFields = ['name', 'description', 'role_key'];
    columns = [
        {
            key: 'name',
            header: 'Name',
        ...
        },
        {
            ...
            transform: value => value ? value.toString().toLowerCase().trim() : null,
            description: 'Unique identifier (optional, auto-generated from name if not provided, lowercase with underscores)',
        },
        {
            key: 'is_active',
            header: 'Is Active',
    ...
    async checkDuplicate(data, tx) {
        const model = tx ? tx.roles : prisma_client_1.default.roles;
        if (data.name) {
    ...
    async exportToExcel(options = {}) {
        ...
        if (data.some((role) => role.roles_permission?.length > 0)) {
            ...
            data.forEach((role) => {
                if (role.roles_permission && role.roles_permission.length > 0) {
                    role.roles_permission.forEach((rp) => {
        ...
        if (data.some((role) => role.user_role?.length > 0)) {
...
exports.RoleImportExportService = RoleImportExportService;
//# sourceMappingURL=role.import-export.service.js.map