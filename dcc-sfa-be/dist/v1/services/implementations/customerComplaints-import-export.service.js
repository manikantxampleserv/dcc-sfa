...
exports.CustomerComplaintsImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
class CustomerComplaintsImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'customer_complaints';
    displayName = 'Customer Complaints';
    uniqueFields = [];
    searchFields = ['complaint_title', 'complaint_description'];
    columns = [
        {
            key: 'customer_id',
            header: 'Customer ID',
            ...
            description: 'ID of the customer (required, must exist in customers table)',
        },
        {
            key: 'complaint_title',
        ...
        },
        {
            ...
            description: 'Status - P for Pending, R for Resolved, C for Closed (defaults to P)',
        },
        {
            key: 'submitted_by',
            ...
            description: 'ID of the user who submitted the complaint (required, must exist in users table)',
        },
    ];
    async getSampleData() {
        try {
            ...
            return [
                {
                    ...
                    complaint_description: 'Product quality issue - received damaged goods in last delivery',
                    status: 'P',
                ...
                },
                {
                    ...
                    complaint_description: 'Delivery delay - order was supposed to arrive on Monday but came on Wednesday',
                    status: 'P',
                    submitted_by: userId1,
                },
                {
                    ...
                    complaint_description: 'Billing discrepancy - invoice amount does not match order total',
                    status: 'R',
                    submitted_by: userId1,
                },
            ];
            ...
            return [
                {
                    customer_id: 999,
                    complaint_title: 'Product Quality Issue',
                    complaint_description: 'Product quality issue - received damaged goods in last delivery. Please replace customer_id with a valid customer ID from your database.',
                    status: 'P',
                    submitted_by: 999,
                },
                {
                    customer_id: 999,
                    complaint_title: 'Delivery Delay',
                    complaint_description: 'Delivery delay - order was supposed to arrive on Monday but came on Wednesday. Please replace customer_id with a valid customer ID from your database.',
                    status: 'P',
                    submitted_by: 999,
                },
                {
                    customer_id: 999,
                    complaint_title: 'Billing Discrepancy',
                    complaint_description: 'Billing discrepancy - invoice amount does not match order total. Please replace customer_id and submitted_by with valid IDs from your database.',
                    status: 'R',
                    submitted_by: 999,
                },
            ];
...
exports.CustomerComplaintsImportExportService = CustomerComplaintsImportExportService;
//# sourceMappingURL=customerComplaints-import-export.service.js.map