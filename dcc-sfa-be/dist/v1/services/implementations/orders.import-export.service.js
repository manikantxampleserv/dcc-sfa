...
class OrdersImportExportService extends import_export_service_1.ImportExportService {
    ...
    columns = [
        ...
        },
        {
            ...
            description: 'Date when order was placed (optional, defaults to current date)',
        },
        {
            key: 'delivery_date',
            ...
            description: 'Expected delivery date (optional, YYYY-MM-DD format, cannot be past date)',
        },
        {
            key: 'status',
            header: 'Status',
            ...
            description: 'Order status: draft, pending, confirmed, processing, shipped, delivered, cancelled, returned (defaults to draft)',
        },
        {
            key: 'priority',
            header: 'Priority',
            ...
            description: 'Order priority: low, medium, high, urgent (defaults to medium)',
        },
        {
            key: 'order_type',
            header: 'Order Type',
            ...
            description: 'Type of order: regular, rush, bulk, sample, return, exchange (defaults to regular)',
        },
        {
            key: 'payment_method',
            ...
            description: 'Payment method: cash, credit, debit, check, bank_transfer, online (defaults to credit)',
        },
        {
            key: 'payment_terms',
            ...
            description: 'Payment terms (optional, max 50 chars, defaults to "Net 30")',
        },
        {
            key: 'subtotal',
            header: 'Subtotal',
        ...
        },
        {
            ...
            validation: value => {
                ...
                const amount = parseFloat(value);
                if (isNaN(amount))
                    return 'Tax amount must be a number';
                if (amount < 0)
        ...
        },
        {
            ...
            validation: value => {
                ...
                const amount = parseFloat(value);
                if (isNaN(amount))
                    return 'Shipping amount must be a number';
                if (amount < 0)
        ...
        },
        {
            ...
            description: 'Order notes or special instructions (optional, max 1000 chars)',
        },
        {
        ...
        },
        {
            ...
            description: 'Approval status: pending, approved, rejected, review (defaults to pending)',
        },
        {
            key: 'approved_by',
    ...
    async prepareDataForImport(data, userId) {
        ...
        if (data.subtotal !== null && data.subtotal !== undefined) {
            preparedData.subtotal = new client_1.Prisma.Decimal(data.subtotal);
        }
        else {
            preparedData.subtotal = new client_1.Prisma.Decimal(0);
        }
        if (data.discount_amount !== null && data.discount_amount !== undefined) {
            preparedData.discount_amount = new client_1.Prisma.Decimal(data.discount_amount);
        }
        else {
            preparedData.discount_amount = new client_1.Prisma.Decimal(0);
        }
        if (data.tax_amount !== null && data.tax_amount !== undefined) {
            preparedData.tax_amount = new client_1.Prisma.Decimal(data.tax_amount);
        }
        else {
            preparedData.tax_amount = new client_1.Prisma.Decimal(0);
        }
        if (data.shipping_amount !== null && data.shipping_amount !== undefined) {
            preparedData.shipping_amount = new client_1.Prisma.Decimal(data.shipping_amount);
        }
        else {
            preparedData.shipping_amount = new client_1.Prisma.Decimal(0);
        }
        if (data.total_amount !== null && data.total_amount !== undefined) {
            preparedData.total_amount = new client_1.Prisma.Decimal(data.total_amount);
        }
        else {
    ...
    async updateExisting(data, userId, tx) {
        ...
        const updateData = {
            ...
            order_date: data.order_date !== undefined ? data.order_date : existing.order_date,
        ...
        if (data.subtotal !== null && data.subtotal !== undefined) {
            updateData.subtotal = new client_1.Prisma.Decimal(data.subtotal);
        }
        if (data.discount_amount !== null && data.discount_amount !== undefined) {
            updateData.discount_amount = new client_1.Prisma.Decimal(data.discount_amount);
        }
        if (data.tax_amount !== null && data.tax_amount !== undefined) {
            updateData.tax_amount = new client_1.Prisma.Decimal(data.tax_amount);
        }
        if (data.shipping_amount !== null && data.shipping_amount !== undefined) {
            updateData.shipping_amount = new client_1.Prisma.Decimal(data.shipping_amount);
        }
        if (data.total_amount !== null && data.total_amount !== undefined) {
            updateData.total_amount = new client_1.Prisma.Decimal(data.total_amount);
        }
