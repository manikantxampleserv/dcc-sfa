...
exports.ProductSubCategoriesImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
const ExcelJS = __importStar(require("exceljs"));
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
class ProductSubCategoriesImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'product_sub_categories';
    displayName = 'Product Sub Categories';
    uniqueFields = ['sub_category_name', 'product_category_id'];
    searchFields = ['sub_category_name', 'description'];
    columns = [
        {
            ...
            description: 'Name of the product sub category (required, 2-100 characters)',
        },
        {
        ...
        },
        {
            ...
            description: 'Description of the product sub category (optional, max 500 characters)',
        },
        {
            key: 'is_active',
            header: 'Is Active',
...
- Description helps users understand the sub category purpose.
    ...
    async checkDuplicate(data, tx) {
        const model = tx
            ...
            : prisma_client_1.default.product_sub_categories;
    ...
    async exportToExcel(options = {}) {
        ...
        exportData.forEach((row, index) => {
            const excelRow = worksheet.addRow({
                ...row,
                product_category_name: data[index]?.product_category?.category_name || '',
            });
            if (index % 2 === 0) {
                excelRow.fill = {
                    type: 'pattern',
...
exports.ProductSubCategoriesImportExportService = ProductSubCategoriesImportExportService;
//# sourceMappingURL=productSubCategories-import-export.service.js.map