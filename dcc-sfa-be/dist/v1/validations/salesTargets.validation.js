...
exports.updateSalesTargetValidation = exports.createSalesTargetValidation = void 0;
const express_validator_1 = require("express-validator");
exports.createSalesTargetValidation = [
    (0, express_validator_1.body)('sales_target_group_id')
        .notEmpty()
...
exports.updateSalesTargetValidation = [
    (0, express_validator_1.body)('sales_target_group_id')
        .optional()
        .isInt({ min: 1 })
        .withMessage('Sales target group ID must be a positive integer'),
...
//# sourceMappingURL=salesTargets.validation.js.map