...
export class ProductShelfLifeImportExportService extends ImportExportService<any> {
  protected modelName = 'product_shelf_life' as const;
  protected displayName = 'Product Shelf Life';
  ...
  protected columns: ColumnDefinition[] = [
    {
      ...
      description:
        'Name of the product shelf life (required, 2-255 characters)',
    },
    {
      key: 'code',
      header: 'Code',
  ...
  protected async checkDuplicate(data: any, tx?: any): Promise<string | null> {
    const model = tx ? tx.product_shelf_life : prisma.product_shelf_life;
