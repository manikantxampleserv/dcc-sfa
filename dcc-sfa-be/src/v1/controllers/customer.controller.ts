...
export const customerController = {
            ...
            if (!existingCustomer) {
              ...
              try {
                ...
                if (
                  ...
                  if (!createdCustomer) {
                    throw new Error(
                      'Customer was auto-approved but failed to create.'
                    );
                  }
                ...
                results.skipped.push({
                  customer: customerData,
                  reason:
                    'Customer skipped because a duplicate record was found.',
                });
                continue;
              }
  ...
  async getAllCustomers(req: any, res: any) {
    try {
      ...
      const statsFilter: any = { ...filters };
      const { is_active: _statIsActive, ...statsFilterWithoutActive } =
        statsFilter;
