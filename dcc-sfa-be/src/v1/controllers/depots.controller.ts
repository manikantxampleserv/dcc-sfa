  ...
  async deleteDepots(req: Request, res: Response) {
    try {
      ...
      if (
        ...
        return res.status(400).json({
          message:
            'Cannot delete depot. It is referenced by other records. Please update or delete those records first.',
        });
      }
