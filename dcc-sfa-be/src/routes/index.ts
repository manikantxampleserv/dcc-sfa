...
import mobileErrorLogs from '../v1/routes/mobileErrorLogs.routes';
...
import coolerTrackingDashboard from '../v1/routes/coolerTrackingDashboard.routes';
...
import salesControlTower from '../v1/routes/salesControlTower.routes';
...
routes.use('/v1', auth);
routes.use('/v1', user);
routes.use('/v1/sales-control-tower', salesControlTower);
routes.use('/v1', roles);
...
routes.use('/v1/reports', coolerTrackingDashboard);
