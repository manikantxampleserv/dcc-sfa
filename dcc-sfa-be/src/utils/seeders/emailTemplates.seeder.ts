...
const mockTemplates: MockTemplate[] = [
  ...
  },
  {
    ...
    type: 'notification',
    subject:
      'Action Required: ${request_type} Request Pending Your Approval - ${request_number}',
  ...
  },
  {
    ...
    type: 'notification',
    subject:
      'Approval Required: ${request_type} Request from ${requester_name}',
...
export async function seedEmailTemplates(): Promise<void> {
  try {
    for (const template of mockTemplates) {
      await prisma.sfa_d_templates.upsert({
 ...
 */
export async function clearEmailTemplates(): Promise<void> {
  try {
    await prisma.sfa_d_templates.deleteMany({});
