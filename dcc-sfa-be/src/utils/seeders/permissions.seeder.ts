...
const MODULE_MAPPING: Record<string, string> = {
  ...
  'asset-warranty': 'Asset Warranty Claim',
  warehouse: 'Warehouse',
  vehicle: 'Vehicle',
  brand: 'Brand',
  ...
  'sales-target-override': 'Sales Target Override',
  ...
  'promotion-parameter': 'Promotion Parameter',
  order: 'Order',
  ...
  'credit-note-item': 'Credit Note Item',
  visit: 'Visit',
  'visit-task': 'Visit Task',
  ...
  'stock-transfer-line': 'Stock Transfer Line',
  ...
  'customer-group-member': 'Customer Group Member',
  ...
  'pricelist-item': 'Price List Item',
  'route-pricelist': 'Route Price List',
