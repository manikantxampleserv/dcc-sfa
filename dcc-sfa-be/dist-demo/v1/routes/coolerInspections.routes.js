...
router.put('/cooler-inspections/:id', multer_1.upload.array('images', 10), auth_middleware_1.authenticateToken, (0, audit_middleware_1.auditUpdate)('cooler_inspections'), (0, auth_middleware_1.requirePermission)([{ module: 'inspection', action: 'update' }]), coolerInspections_controller_1.coolerInspectionsController.updateCoolerInspection);
