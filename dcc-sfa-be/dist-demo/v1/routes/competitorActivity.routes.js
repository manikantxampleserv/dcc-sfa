...
router.put('/competitor-activity/:id', multer_1.upload.single('image'), auth_middleware_1.authenticateToken, (0, audit_middleware_1.auditUpdate)('competitor_activities'), (0, auth_middleware_1.requirePermission)([{ module: 'competitor', action: 'update' }]), competitorActivity_controller_1.competitorActivityController.updateCompetitorActivity);
