...
exports.mockAssetTypes = void 0;
exports.seedAssetTypes = seedAssetTypes;
exports.clearAssetTypes = clearAssetTypes;
...
exports.mockAssetTypes = mockAssetTypes;
/**
...
async function seedAssetTypes() {
    try {
        for (const assetType of mockAssetTypes) {
            const existingAssetType = await prisma_client_1.default.asset_types.findFirst({
                where: { name: assetType.name },
            });
            if (!existingAssetType) {
                await prisma_client_1.default.asset_types.create({
                    data: {
                        name: assetType.name,
 ...
 */
async function clearAssetTypes() {
    try {
        await prisma_client_1.default.asset_types.deleteMany({});
    }
    catch (error) {
        throw error;
    }
}
//# sourceMappingURL=assetTypes.seeder.js.map