...
exports.seedSurveyTemplates = seedSurveyTemplates;
exports.clearSurveyTemplates = clearSurveyTemplates;
...
const mockSurveyTemplates = [
    ...
    },
    {
        ...
        description: 'Survey to assess product quality and identify improvement areas',
...
async function seedSurveyTemplates() {
    try {
        ...
        for (const template of mockSurveyTemplates) {
            const existingTemplate = await prisma_client_1.default.surveys.findFirst({
            ...
            if (!existingTemplate) {
                ...
                await prisma_client_1.default.surveys.create({
                    data: {
        ...
        logger_1.default.info(`Survey Templates seeding completed: ${templatesCreated} created, ${templatesSkipped} skipped`);
    }
    catch (error) {
        logger_1.default.error('Error seeding survey templates:', error);
        throw error;
    }
}
/**
 ...
 */
async function clearSurveyTemplates() {
    try {
        await prisma_client_1.default.surveys.deleteMany({});
    }
    catch (error) {
        throw error;
    }
}
//# sourceMappingURL=survey-templates.seeder.js.map