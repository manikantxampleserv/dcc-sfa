 ...
 */
async function createApprovalWorkflow(params) {
    try {
        const { workflow_type, reference_type, reference_id, reference_number, requested_by, priority = 'medium', request_data, steps, createdby = 1, } = params;
        const referenceIdUuid = reference_id || (0, crypto_1.randomUUID)();
