...
exports.mockAssets = void 0;
exports.seedAssetMaster = seedAssetMaster;
exports.clearAssetMaster = clearAssetMaster;
    ...
    try {
        ...
        for (const asset of mockAssets) {
            ...
            if (!existingAsset) {
                ...
                const assetType = assetTypes.find(at => at.name === asset.asset_type_name);
                if (assetType) {
                    await prisma_client_1.default.asset_master.create({
                        data: {
 ...
 */
async function clearAssetMaster() {
    try {
        await prisma_client_1.default.asset_master.deleteMany({});
    }
    catch (error) {
        throw error;
    }
}
//# sourceMappingURL=assetMaster.seeder.js.map