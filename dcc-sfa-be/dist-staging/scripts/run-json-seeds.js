...
async function main() {
    ...
    try {
        await prisma_client_1.default.$executeRawUnsafe(`EXEC sp_msforeachtable "ALTER TABLE ? NOCHECK CONSTRAINT all"`);
    ...
    try {
        await prisma_client_1.default.$executeRawUnsafe(`EXEC sp_msforeachtable "ALTER TABLE ? WITH CHECK CHECK CONSTRAINT all"`);
...
//# sourceMappingURL=run-json-seeds.js.map