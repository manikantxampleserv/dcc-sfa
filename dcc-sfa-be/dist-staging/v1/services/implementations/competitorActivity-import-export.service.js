...
exports.CompetitorActivityImportExportService = void 0;
const import_export_service_1 = require("../base/import-export.service");
const prisma_client_1 = __importDefault(require("../../../configs/prisma.client"));
class CompetitorActivityImportExportService extends import_export_service_1.ImportExportService {
    modelName = 'competitor_activity';
    displayName = 'Competitor Activities';
    uniqueFields = ['customer_id', 'brand_name', 'product_name'];
    searchFields = [
        'brand_name',
        'product_name',
        'promotion_details',
    ...
    async checkDuplicate(data, tx) {
        const model = tx ? tx.competitor_activity : prisma_client_1.default.competitor_activity;
    ...
    async validateForeignKeys(data, tx) {
        const model = tx ? tx : prisma_client_1.default;
...
exports.CompetitorActivityImportExportService = CompetitorActivityImportExportService;
//# sourceMappingURL=competitorActivity-import-export.service.js.map