...
router.get('/route-assignments', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requirePermission)([{ module: 'route', action: 'read' }]), routes_controller_1.routesController.getRouteAssignments);
router.get('/route-assignments/:userId', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requirePermission)([{ module: 'route', action: 'read' }]), routes_controller_1.routesController.getRouteAssignmentsByUser);
router.post('/route-assignments/:userId', auth_middleware_1.authenticateToken, (0, audit_middleware_1.auditUpdate)('route_salespersons'), (0, auth_middleware_1.requirePermission)([{ module: 'route', action: 'update' }]), routes_controller_1.routesController.setRouteAssignmentsForUser);
