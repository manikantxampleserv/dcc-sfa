...
router.post('/import-export/:table/preview', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requirePermission)([{ module: 'report', action: 'create' }]), multer_1.uploadExcel.single('file'), import_export_validation_1.validateImport, import_export_controller_1.importExportController.previewImport);
